<footer>
     ...
     <div class="footer-lg py-5 mt-lg-5">
       <div class="container">
         <div class="row">
           <div
             class="col-xl-6 col-lg-6 mb-4 mb-lg-0  footer-desc"
           >
             <div class="pe-xl-5">
<div class="row ">
                 ...
                 <div class="row">
                   <div class="col-lg-12 col-sm-6">
                     ...
                     <div class="d-flex align-items-center lh-2 mb-2 d-none">
                       <div class="icon-wrap">
                       <img
                         src="<?php bloginfo('template_directory')?>/dist/img/phone.svg"
                         alt="Mail"
                         class="icon-phone"
                       />
                     </div>
                     ...
                     <div class="d-flex align-items-center lh-2 mb-5">
                       <div class="icon-wrap">
                       <img
                         src="<?php bloginfo('template_directory')?>/dist/img/email.svg"
                         alt="Phone"
                         class="icon-email"
                       />
                       </div>  
       ...
       <div class="container">
           <div class="footer-cprt d-lg-flex justify-content-between ">
               ...
               <ul class="social-container">
                   ...
                   <li><a href="https://www.instagram.com/trophopbeers/" target="_blank"><i class="fa fa-brands fa-instagram"></i></a></li>
   ...
   <script
     ...
     src="<?php bloginfo('template_directory')?>/dist/js/bootstrap.bundle.min.js"
   ></script>
   <script
