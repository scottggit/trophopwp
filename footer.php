<footer>
    ...
    <div class="footer-lg py-5 mt-lg-5">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 mb-4 mb-lg-0  footer-desc">
                    <div class="pe-xl-5">
                        <div class="row ">
                            <div class="col-md-5 text-center">
                                <img src="<?php bloginfo('template_directory') ?>/dist/img/footer-logo.png" alt="Logo"
                                    class="footer-logo mb-5 w-100" />
                            </div>
                            <?php /*
              <div class="col-md-8">
                    ...
                    <div class="col-xl-7 col-md-6 col-12 col-lg-7">
                        <div class="row">
                            <div class="col-lg-12 col-sm-6">
                                ...
                                <div class="d-flex align-items-center lh-2 mb-2 d-none">
                                    <div class="icon-wrap">
                                        <img src="<?php bloginfo('template_directory') ?>/dist/img/phone.svg" alt="Mail"
                                            class="icon-phone" />
                                    </div>
                                ...
                                <div class="d-flex align-items-center lh-2 mb-5">
                                    <div class="icon-wrap">
                                        <img src="<?php bloginfo('template_directory') ?>/dist/img/email.svg"
                                            alt="Phone" class="icon-email" />
                                    </div>
        ...
        <div class="container">
            <div class="footer-cprt d-lg-flex justify-content-between ">
                ...
                <ul class="social-container">
                    ...
                    <li><a href="https://www.instagram.com/trophopbeers/" target="_blank"><i
                ...
                <span>Designed & Developed by <a href="https://revealize.com/"
                        target="_blank"><strong>Revealize</strong></span></a>
            </div>
        </div>
    </div>
</footer>
