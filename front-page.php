...
<div class="row">
  <div class="col-md-7">  
    <img src="<?php bloginfo('template_directory')?>/dist/img/wheat-ale.png" alt=""  class="w-100">
  </div>
  <div class="col-md-5">  
    <h3>Beach</h3>
...
<img src="<?php bloginfo('template_directory')?>/dist/img/hats/hat1.png" alt="Logo" class="img-fluid">
<a href="" class="btn add-to-cart">Add to cart</a>
</span>
...
<span class="logo-img_container">
  <p>Hop Trucker Hat: Teal</p>
  <div class="price">$38.50</div>
  <img src="<?php bloginfo('template_directory')?>/dist/img/hats/hat2.png" alt="Logo" class="img-fluid">
  <a href="" class="btn add-to-cart">Add to cart</a>
</span><span class="logo-img_container">
  <p>Hop Trucker Hat: Teal</p>
  <div class="price">$38.50</div>
  <img src="<?php bloginfo('template_directory')?>/dist/img/hats/hat3.png" alt="Logo" class="img-fluid">
  <a href="" class="btn add-to-cart">Add to cart</a>
</span><span class="logo-img_container">
  <p>Hop Trucker Hat: Teal</p>
  <div class="price">$38.50</div>
  <img src="<?php bloginfo('template_directory')?>/dist/img/hats/hat4.png" alt="Logo" class="img-fluid">
  <a href="" class="btn add-to-cart">Add to cart</a>
</span><span class="logo-img_container">
  <p>Hop Trucker Hat: Teal</p>
  <div class="price">$38.50</div>
