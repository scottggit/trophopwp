...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxN6etPUCplYLQ-8bNRqt6V7yuXIwDy54&libraries=places"></script>
...
<div class="content">
    <section class="page-banner" style="background:#F8F8FF">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-5 offset-custom-md col-md-5 col-12 offset-lg-2 offset-md-1 order-md-1 px-5 px-lg-3">
                    <div class="d-flex align-items-center h-100">
                        <div class="searchwrap text-center text-lg-start">
                            <h1 class="display-1 title-sm mb-0 mt-md-5"><span class="bg-title-light">Where To Buy</span></h1>
    ...
    <section class="map">
        <div class="container-fluid p-0">
            <div class="row m-0">
                <div class="col-md-8 col-xxl-9 px-0">
                    <div class="bg-[#DBB383] p-5 relative">
                        ...
                        <div class="container d-flex">
                            ...
                            <div class="d-flex w-40 my-auto">
                                <select id="miles-select" class="focus:outline-none text-[20px] text-white w-100 bg-transparent border-b-[1px] border-b-[#fff]">
                ...
                <div class="col-md-4 col-xxl-3 px-0 relative">
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample" style='height:100vh;'>
                            <?php foreach ($posts as $post) : ?>
                                <div class="accordion-item mb-0">
                                    ...
                                    <div id="flush-collapse<?php echo $post->ID ?>" class="accordion-collapse collapse" aria-labelledby="flush-<?php echo $post->ID ?>" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body" data-lat=" <?php echo the_field('lat') ?>" data-lon=" <?php echo the_field('lon') ?>">
                                            <div>testpage1</div>
                                            <a target="_blank" class="direction-btn d-none"> <button class="bg-[#3E4852] px-3 py-2 uppercase text-white">Direction</button></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
