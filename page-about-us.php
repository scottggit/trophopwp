                ...
                <div class="col-md-6">
                    <div class="d-flex align-items-center h-100">
                        <div class="about-desc mt-5">
                            ...
                            <div class="d-flex align-items-start gap-3 mb-5 pt-3">
    ...
    <div class="section-content py-5 mt-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <img src="<?php bloginfo('template_directory') ?>/dist/img/Group 202@2x.png" alt=""
                        class="img-fluid imgSlideUp sec2Img slideUp">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-content py-5 mt-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-sm-6">
                    <img src="<?php bloginfo('template_directory') ?>/dist/img/Group 203@2x.png" alt=""
                        class="img-fluid imgSlideUp sec3Img slideUp">
                </div>
            </div>
        </div>
    </div>
