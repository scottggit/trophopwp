...
<div class="content">
                ...
                <div class="col-lg-5  offset-custom-md col-md-5 col-12 offset-lg-2 offset-md-1 order-md-1">
                    <div class="d-flex align-items-center h-100">
                        <div class="searchwrap">
                            <h1 class="display-1 mb-4"><span class="bg-title-light">About Us</span></h1>
    ...
    <section class="aboutus-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <img src="<?php bloginfo('template_directory') ?>/dist/img/aboutus.png" alt=""
                        class="w-100 img-2-lg-bg">
                </div>
                <div class="col-md-6">
                    <div class="d-flex align-items-center h-100">
                        <div class="about-desc mt-5">
                            <h2 class="display-2">Hey Friends!</h2>
                            <p>Thanks for coming to TropHop beers official page! We are so appreciative for your support
                                through the years. I am forever grateful.</p>
                            <p>My passion for beer is what started my journey to develop TropHop. I started with my
                                grapefruit and passion fruit IPA with its first launch in the summer of 2019 in
                                Charleston, SC. Since then we have developed two more beers our luxury lager and the
                                beachy wheat all being sold in SC, NC, FL, & AL! We are launching into new states and
                                growing the brand every day. I have developed all my beers to be approachable and easy
                                drinking. I hope you are all
                                enjoying it as much as I do!</p>
                            <p>I’m so sorry I can’t ship it to you yet. We are still working on that one, but we hope
                                that we can
                                send you some merch instead.</p>
                            <div class="d-flex align-items-start gap-3 mb-5">
                                <img src="<?php bloginfo('template_directory') ?>/dist/img/quote-up.svg" alt=""
