...
<div class="product-nav">
    ...
    <ul>
        <li><a href="<?php echo get_site_url() ?>/shop/tropical-fruited/" class="opacity-50"><img src="<?php bloginfo('template_directory') ?>/dist/img/tropical-fruited-single.png" alt="Tropical Fruited"></a></li>
