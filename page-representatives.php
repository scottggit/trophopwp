        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12 col-xl-5 col-lg-6-custom p-0  order-md-2 mb-4 mb-md-0">
                    <img src="<?php bloginfo('template_directory') ?>/dist/img/representative-banner.jpg" alt="" class="w-100 rep-banner">
                </div>
                <div class="col-lg-5  offset-custom-md col-md-5 col-12 offset-lg-2 offset-md-1 order-md-1">
                    <div class="d-flex align-items-center h-100">
                        <div class="searchwrap stores-search">
                            <h1 class="display-1 mb-4 text-center text-lg-start"><span class="bg-title-light title-md position-relative pe-lg-2 z-2">Distribution</span></h1>
            ...
            ?>
                    ...
                    ?>
                        <div class="row py-5">
                            ...
                            <div class="col-md-4 offset-md-2  order-md-1 text-center text-lg-start">
                                <h5><?php echo get_field('state') ?></h5>
                                <h2 class="mb-5"><?php the_title(); ?></h2>
                                <a class="btn btn-white btn-hover-dark animate__animated" href="mailto:<?php echo get_field('link') ?>"><?php echo get_field('link'); ?></a>
                            </div>
                    ...
                    ?>
                        <div class="row py-5">
                            ...
                            <div class="col-md-5 offset-md-1 text-center text-lg-start">
                                <h5><?php echo get_field('state') ?></h5>
                                <h2 class="mb-5"><?php the_title(); ?></h2>
                                <a class="btn btn-white btn-hover-dark animate__animated" href="mailto:<?php echo get_field('link') ?>"><?php echo get_field('link'); ?></a>
                            </div>
